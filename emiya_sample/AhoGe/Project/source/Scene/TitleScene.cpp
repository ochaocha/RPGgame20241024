	...
	namespace Sceneclass {
		void			TitleScene::Set_Sub(void) noexcept {
			...
			ButtonParts->AddStringButton(
				"Let's Go!", 52, true,
				1920 - 64 - 48, 1080 - 84 - 64 * 2, UISystem::FontXCenter::RIGHT, UISystem::FontYCenter::BOTTOM);
			ButtonParts->AddStringButton(
				"Reset SaveData", 48, true,
				1920 - 64, 1080 - 84 - 64 * 1, UISystem::FontXCenter::RIGHT, UISystem::FontYCenter::BOTTOM);
			ButtonParts->AddIconButton(
				"data/UI/setting.png", true,
				1920 - 96 - 64, 64, UISystem::FontXCenter::MIDDLE, UISystem::FontYCenter::MIDDLE);
			ButtonParts->AddIconButton(
				"data/UI/credit.png", true,
				1920 - 64, 64, UISystem::FontXCenter::MIDDLE, UISystem::FontYCenter::MIDDLE);
			// クレジット
		...
		void			TitleScene::DrawUI_Base_Sub(void) const noexcept {
			...
			// 
			Fonts->Get(UISystem::FontPool::FontType::MS_Gothic, DrawParts->GetUIY(18), 3)->DrawString(InvalidID, UISystem::FontXCenter::RIGHT, UISystem::FontYCenter::TOP,
			...
			if ((ButtonParts->GetSelect() != InvalidID) && !PopUpParts->IsActivePop()) {
				...
				Fonts->Get(UISystem::FontPool::FontType::MS_Gothic, DrawParts->GetUIY(18), 3)->DrawString(InvalidID, UISystem::FontXCenter::LEFT, UISystem::FontYCenter::BOTTOM,
